            ...
            <div className='container d-none d-lg-block'>
                <div className='row mt-5'>
                    <div className='col-sm-2 col-md-2'>
                        {book?.img ?
                            <img src={customerProfilePictureUrl(book.title)} width='226' height='349' alt='Book' />
                            :
                            <img src={require('C:/Users/Quigas/Fullstack/react-library/src/Images/BooksImages/noimage.jpg')} width='226'
                                height='349' alt='Book' />
                        }
                    </div>
