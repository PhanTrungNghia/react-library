            ...
            <div className='mt-5'>
                ...
                <nav>
                    <div className='nav nav-tabs' id='nav-tab' role='tablist'>
                        ...
                        <button onClick={cartClickFunction} className='nav-link' id='nav-cart-tab' data-bs-toggle='tab'
                ...
                <div className='tab-content' id='nav-tabContent'>
                    ...
                    <div className='tab-pane fade' id='nav-cart' role='tabpanel' aria-labelledby='nav-cart-tab'>
                        {cartClick ? <CartPages/> : <></>}
                    </div>
                </div>
            </div>
