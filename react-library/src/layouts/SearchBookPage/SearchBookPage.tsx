    ...
    useEffect(() => {
        const fetchBooks = async () => {
            ...
            if (searchUrl === '') {
                ...
                // Example: '/search/findByTitleContaining?title=someTitle&page=2&size=5'
        ...
        // Each time this use effect get recalled
        // we're going to scroll the page to the top
        window.scrollTo(0, 0);
                        ...
                        <div className='col-4'>
                            <div className='dropdown'>
                                ...
                                <ul className='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
                                    ...
                                    <li onClick={() => categoryField('Manga')}>
                                        <a className='dropdown-item' href='#'>
                                            Manga
                                        </a>
                                    </li>
